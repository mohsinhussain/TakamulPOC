...
import com.tatweer.moh.takamulpoc.Adapters.CategoriesAdapter;
...
//                Integer.toString(args.getInt(ARG_OBJECT)));
        ...
        adapter = new CategoriesAdapter(getActivity(), categoryList, getActivity());
...
//        recyclerView.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
    ...
    private void prepareAlbums() {
        int[] covers = new int[]{
                ...
                R.drawable.its_traffic,
                R.drawable.kamerasystem,
                R.drawable.transport_infrastructure,
                R.drawable.its_traffic2,
                R.drawable.parking,
                R.drawable.smart2,
                R.drawable.smart_city,
                R.drawable.sittraffic_one,
                R.drawable.balls,
                R.drawable.phone};

        Category a = new Category("Road Safety Products", covers[0], getRandomNumber(1, 40));
        categoryList.add(a);

        a = new Category("ITS Traffic Management", covers[1], getRandomNumber(1, 40));
        categoryList.add(a);

        a = new Category("Digital Lane System", covers[2], getRandomNumber(1, 40));
        categoryList.add(a);

        a = new Category("Transport infrastructure", covers[3], getRandomNumber(1, 40));
        categoryList.add(a);

        a = new Category("Traffic Management", covers[4], getRandomNumber(1, 40));
        categoryList.add(a);

        a = new Category("Parking", covers[5], 20);
        categoryList.add(a);

        a = new Category("Parking, Tickets", covers[6], 20);
        categoryList.add(a);

        a = new Category("Smart City", covers[7], 20);
        categoryList.add(a);

        a = new Category("Transport infrastructure", covers[8], 20);
        categoryList.add(a);
