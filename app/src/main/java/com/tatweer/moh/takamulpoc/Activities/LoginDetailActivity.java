...
public class LoginDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _signupLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), RegisterVisitor.class);
    ...
    public void login() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(LoginDetailActivity.this,
                R.style.AppTheme);
...
//    }
    ...
    public void onLoginSuccess() {
        ...
        startActivity(new Intent(LoginDetailActivity.this, MainActivity.class));
